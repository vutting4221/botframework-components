...
using SymptomBasedSkill.Adapters;
using SymptomBasedSkill.Authentication;
using SymptomBasedSkill.Bots;
using SymptomBasedSkill.Dialogs;
using SymptomBasedSkill.ServiceBusHandler;
using SymptomBasedSkill.Services;

namespace SymptomBasedSkill
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // Register dialogs
            services.AddTransient<PrimarySymptomsCheckDialog>();
